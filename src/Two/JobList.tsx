...
const JobList = () => {
  return (
    <div className="wid-[40rem] rounded-md bg-white p-16">
      <div className="flex gap-2">
        ...
        <button className="font-popi flex items-center gap-2 rounded-md bg-[#281A51] px-6 py-2 text-white hover:bg-blue-600 focus:outline-none">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
